...
#define MC 0x80000000UL           /* permet de diagonaliser la matrice dans la 
                                     fonction Diag() */
...
/* ********************************************************************** */
boolean Diag (Matrix * m, int kg, int t, int l, int *gr)
{
   int i, j, cl, rang;
...
/* ********************************************************************** */
boolean CompareBV (BitVect * A, BitVect * B)
{
...
/* ********************************************************************** */
/* boolean CheckCD( BitVect ds1, BitVect ds2 )                            */
...
/* ********************************************************************** */
void DispMat (Matrix * m, int t, int l, int kg, boolean mathematica)
{
   int i, j;

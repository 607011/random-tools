...
extern boolean scatter_Over;       /* = TRUE: overlapping points */
...
extern boolean scatter_Lacunary;   /* = TRUE: lacunary case */
...
void scatter_PlotUnif1 (unif01_Gen *gen, long N, int t, boolean Over,
   int Proj[2], double Lower[], double Upper[], scatter_OutputType Output,
   int Prec, boolean Lac, long LacI[], char *Name);

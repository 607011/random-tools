...
struct snpair_Res {
   ...
   boolean CleanFlag;               /* If TRUE, free all memory */
   void *work;
...
void snpair_WriteDataCP (unif01_Gen *gen, char *TestName, long N, long n,
                         int r, int t, int p, int m, boolean Torus);
...
extern boolean snpair_mNP2S_Flag;
...
void snpair_WriteDataBB (unif01_Gen *gen, char *TestName, long N, long n,
                         int r, int t, int p, boolean Tor, int L1, int L2);
...
void snpair_BickelBreiman (unif01_Gen *gen, snpair_Res *res, long N,
                           long n, int r, int t, int p, boolean Torus);

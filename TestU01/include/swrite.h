...
extern boolean swrite_Basic;           /* Prints basic results           */
extern boolean swrite_Parameters;      /* Prints details on parameters   */
extern boolean swrite_Collectors;      /* Prints statistical collectors  */
extern boolean swrite_Classes;         /* Prints classes for ChiSquare   */
extern boolean swrite_Counters;        /* Prints counters                */



extern boolean swrite_Host;
